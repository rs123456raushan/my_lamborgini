            ...
            (function(o) {
                ...
                void 0 === (s = "function" == typeof(r = function() {
                    ...
                    const h = Zone.__symbol__,
                        ...
                        f = p ? window : void 0,
                        d = p && f || "object" == typeof self && self || o,
                        g = [null];
                    ...
                    const m = "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope,
                        y = !("nw" in d) && void 0 !== d.process && "[object process]" === {}.toString.call(d.process),
                        v = !y && !m && !(!p || !f.HTMLElement),
                    ...
                    function w(n, o, r) {
                        ...
                        const a = s.get,
                            ...
                            l = o.substr(2);
                        let u = T[l];
                        u || (u = T[l] = h("ON_PROPERTY" + l)), s.set = function(e) {
                            let t = this;
                            t || n !== d || (t = d), t && (t[u] && t.removeEventListener(l, E), c && c.apply(t, g), "function" == typeof e ? (t[u] = e, t.addEventListener(l, E, !1)) : t[u] = null)
                        }, s.get = function() {
                            let e = this;
                    ...
                    function Z(e, t, n) {
                        if (t)
                            for (let o = 0; o < t.length; o++) w(e, "on" + t[o], n);
                        else {
                            const t = [];
                    ...
                    function D(e) {
                        const n = d[e];
                        if (!n) return;
                        d[h(e)] = n, d[e] = function() {
                            const t = _(arguments, e);
                            switch (t.length) {
                                case 0:
                                    this[S] = new n;
                                    break;
                        ...
                        for (r in o) "XMLHttpRequest" === e && "responseBlob" === r || function(n) {
                            "function" == typeof o[n] ? d[e].prototype[n] = function() {
                                return this[S][n].apply(this[S], arguments)
                            } : t(d[e].prototype, n, {
                                set: function(t) {
                                    "function" == typeof t ? (this[S][n] = l(t, e + "." + n), O(this[S][n], t)) : this[S][n] = t
                                },
                                get: function() {
                                    return this[S][n]
                                }
                    ...
                    function P(t, o, r) {
                        ...
                        const i = h(o);
                        let a = null;
                        if (s && !(a = s[i]) && (a = s[i] = s[o], k(s && e(s, o)))) {
                            const e = r(a, i, o);
                            s[o] = function() {
                    ...
                    function N() {
                        ...
                        z = !0;
                        try {
                            const e = f.navigator.userAgent; - 1 === e.indexOf("MSIE ") && -1 === e.indexOf("Trident/") && -1 === e.indexOf("Edge/") || (j = !0)
                        } catch (e) {}
                        return j
                    }
                    ...
                    function G(e, t, o) {
                        const r = o && o.add || "addEventListener",
                            ...
                            a = o && o.rmAll || "removeAllListeners",
                            l = h(r),
                            u = "." + r + ":",
                            p = function(e, t, n) {
                            ...
                            f = function(t) {
                                ...
                                if (o)
                                    if (1 === o.length) p(o[0], n, t);
                                        ...
                                        const e = o.slice();
                                        for (let o = 0; o < e.length && (!t || !0 !== t[H]); o++) p(e[o], n, t)
                                    }
                            },
                            d = function(t) {
                                if (!(t = t || e.event)) return;
                        ...
                        function g(t, o) {
                            ...
                            let m = t;
                            for (; m && !m.hasOwnProperty(r);) m = n(m);
                            ...
                            o && o.prepend && (S = m[h(o.prepend)] = m[o.prepend]);
                            const P = p ? function(e) {
                                ...
                                I = e[h("PASSIVE_EVENTS")],
                                N = function(t, n, r, s, i = !1, a = !1) {
                                    return function() {
                                        const c = this || e;
                                        let l = arguments[0];
                                        ...
                                        if (y && "uncaughtException" === l) return t.apply(this, arguments);
                                        let h = !1;
                                        ...
                                        const C = c.constructor.name,
                                            O = M[C];
                                        O && (Z = O[l]), Z || (Z = C + n + (v ? v(l) : l)), b.options = d, m && (b.options.once = !1), b.target = c, b.capture = k, b.eventName = l, b.isExisting = P;
                                        const N = p ? L : void 0;
                                        N && (N.taskData = b);
                                        const A = T.scheduleEventTask(Z, u, N, r, s);
                                        return b.target = null, N && (N.taskData = null), m && (d.once = !0), (R || "boolean" != typeof A.options) && (A.options = d), A.target = c, A.capture = k, A.eventName = l, h && (A.originalDelegate = u), a ? S.unshift(A) : S.push(A), i ? c : void 0
                                    }
                                };
                            return m[r] = N(T, u, P, C, k), S && (m.prependListener = N(S, ".prependListener:", (function(e) {
                                ...
                                if (u)
                                    for (let e = 0; e < u.length; e++) {
                                        const o = u[e];
                                        if (z(o, i)) return u.splice(e, 1), o.isRemoved = !0, 0 === u.length && (o.allRemoved = !0, t[l] = null, "string" == typeof n) && (t[c + "ON_PROPERTY" + n] = null), o.zone.cancelTask(o), k ? t : void 0
                                    }
                                ...
                                if (k) return this
                            }, O(m[r], T), O(m[s], E), Z && O(m[a], Z), w && O(m[i], w), !0
                        }
                        let _ = [];
                    ...
                    const U = ["absolutedeviceorientation", "afterinput", "afterprint", "appinstalled", "beforeinstallprompt", "beforeprint", "beforeunload", "devicelight", "devicemotion", "deviceorientation", "deviceorientationabsolute", "deviceproximity", "hashchange", "languagechange", "message", "mozbeforepaint", "offline", "online", "paint", "pageshow", "pagehide", "popstate", "rejectionhandled", "storage", "unhandledrejection", "unload", "userproximity", "vrdisplayconnected", "vrdisplaydisconnected", "vrdisplaypresentchange"],
                        ...
                        Y = ["loadstart", "progress", "abort", "error", "load", "progress", "timeout", "loadend", "readystatechange"],
                    ...
                    function re(e, t) {
                        ...
                        if (v) {
                            ...
                            oe(e, te.concat(["messageerror"]), r ? r.concat(t) : r, n(e)), oe(Document.prototype, te, r), void 0 !== e.SVGElement && oe(e.SVGElement.prototype, te, r), oe(Element.prototype, te, r), oe(HTMLElement.prototype, te, r), oe(HTMLMediaElement.prototype, V, r), oe(HTMLFrameSetElement.prototype, U.concat(X), r), oe(HTMLBodyElement.prototype, U.concat(X), r), oe(HTMLFrameElement.prototype, $, r), oe(HTMLIFrameElement.prototype, $, r);
                            const o = e.HTMLMarqueeElement;
                            o && oe(o.prototype, J, r);
                            const s = e.Worker;
                            s && oe(s.prototype, ee, r)
                        }
                        const s = t.XMLHttpRequest;
                        s && oe(s.prototype, Y, r);
                        const i = t.XMLHttpRequestEventTarget;
                        i && oe(i && i.prototype, Y, r), "undefined" != typeof IDBIndex && (oe(IDBIndex.prototype, K, r), oe(IDBRequest.prototype, K, r), oe(IDBOpenDBRequest.prototype, K, r), oe(IDBDatabase.prototype, K, r), oe(IDBTransaction.prototype, K, r), oe(IDBCursor.prototype, K, r)), o && oe(WebSocket.prototype, Q, r)
                    }
                    Zone.__load_patch("util", (n, o, i) => {
                        i.patchOnProperties = Z, i.patchMethod = P, i.bindArguments = _, i.patchMacroTask = C;
                        const a = o.__symbol__("BLACK_LISTED_EVENTS"),
                            u = o.__symbol__("UNPATCHED_EVENTS");
                        n[u] && (n[a] = n[u]), n[a] && (o[a] = o[u] = n[a]), i.patchEventPrototype = q, i.patchEventTarget = G, i.isIEOrEdge = N, i.ObjectDefineProperty = t, i.ObjectGetOwnPropertyDescriptor = e, i.ObjectCreate = r, i.ArraySlice = s, i.patchClass = D, i.wrapWithCurrentZone = l, i.filterProperties = ne, i.attachOriginToPatched = O, i._redefineProperty = Object.defineProperty, i.patchCallbacks = W, i.getGlobalObjects = () => ({
                            globalSources: M,
                    ...
                    function ie(e, t, n, o) {
                        ...
                        function a(t) {
                            ...
                            return n.args[0] = function() {
                                try {
                                    ...
                                    t.data && t.data.isPeriodic || ("number" == typeof n.handleId ? delete i[n.handleId] : n.handleId && (n.handleId[se] = null))
                                }
                        ...
                        r = P(e, t += o, n => function(r, s) {
                            if ("function" == typeof s[0]) {
                                ...
                                return "number" == typeof n ? i[n] = e : n && (n[se] = e), n && n.ref && n.unref && "function" == typeof n.ref && "function" == typeof n.unref && (e.ref = n.ref.bind(n), e.unref = n.unref.bind(n)), "number" == typeof n || n ? n : e
                            }
                            return n.apply(e, s)
                        }), s = P(e, n, t => function(n, o) {
                            const r = o[0];
                            let s;
                            "number" == typeof r ? s = i[r] : (s = r && r[se], s || (s = r)), s && "string" == typeof s.type ? "notScheduled" !== s.state && (s.cancelFn && s.data.isPeriodic || 0 === s.runCount) && ("number" == typeof r ? delete i[r] : r && (r[se] = null), s.zone.cancelTask(s)) : t.apply(e, o)
                        })
                    }
                    ...
                    Zone.__load_patch("legacy", e => {
                        ...
                        for (let o = 0; o < n.length; o++) P(e, n[o], (n, o, r) => function(o, s) {
                        ...
                        ! function(e) {
                            ...
                            function _(e) {
                                ...
                                c[s] = !1, c[l] = !1;
                                const u = c[r];
                                d || (d = c[i], g = c[a]), u && g.call(c, "readystatechange", u);
                                const h = c[r] = () => {
                                    if (c.readyState === c.DONE)
                                        if (!o.aborted && c[s] && "scheduled" === e.state) {
                                        ...
                                        } else o.aborted || !1 !== c[s] || (c[l] = !0)
                                };
                                return d.call(c, "readystatechange", h), c[n] || (c[n] = e), T.apply(c, o.args), c[s] = !0, e
                            }
                                ...
                                T = P(f, "send", () => function(e, n) {
                                    ...
                                    if (e[o]) return T.apply(e, n); {
                                        const t = {
                                            ...
                                            o = u("XMLHttpRequest.send", k, t, _, m);
                                        e && !0 === e[l] && !t.aborted && "scheduled" === o.state && o.invoke()
                                    }
                                }),
                                E = P(f, "abort", () => function(e, o) {
                                    const r = e[n];
