(function() {
    ...
    */
    ...
    function va(a) {
        ...
        (b = a.j = a.j || b) ? b.oa ? a.h = a.o || a.m : void 0 != b.v && a.m < b.v ? (a.h = b.v, a.j = null) : a.h = a.m: a.h = 0
    }
    ...
    r("Map", function(a) {
        ...
        e.prototype.set = function(h, k) {
            ...
            l.A ? l.A.value = k : (l.A = {
                ...
                key: h,
                value: k
            }, l.list.push(l.A), this.h.previous.next = l.A, this.h.previous = l.A, this.size++);
            return this
        };
        e.prototype.delete = function(h) {
            h = d(this, h);
            return h.A && h.list ? (h.list.splice(h.index, 1), h.list.length || delete this.data_[h.id], h.A.previous.next = h.A.next, h.A.next.previous = h.A.previous, h.A.head = null, this.size--, !0) : !1
        };
    ...
    r("Promise", function(a) {
        ...
        b.race = function(g) {
            return new b(function(h, k) {
                for (var l = u(g), m = l.next(); !m.done; m = l.next()) d(m.value).W(h, k)
            })
        };
        b.all = function(g) {
            var h = u(g),
            ...
            return k.done ? d([]) : new b(function(l, m) {
                ...
                var t = [],
                    p = 0;
                do t.push(void 0), p++, d(k.value).W(q(t.length - 1), m), k = h.next(); while (!k.done)
            })
        };
        return b
    });
    ...
    var tb = RegExp('^(?:audio/(?:3gpp2|3gpp|aac|L16|midi|mp3|mp4|mpeg|oga|ogg|opus|x-m4a|x-matroska|x-wav|wav|webm)|font/\\w+|image/(?:bmp|gif|jpeg|jpg|png|tiff|webp|x-icon)|video/(?:mpeg|mp4|ogg|webm|quicktime|x-matroska))(?:;\\w+=(?:\\w+|"[\\w;,= ]+"))*$', "i"),
    ...
    var Nb = H("Opera"),
        Ob = H("Trident") || H("MSIE"),
        Pb = H("Edge"),
        Qb = H("Gecko") && !(-1 != xb.toLowerCase().indexOf("webkit") && !H("Edge")) && !(H("Trident") || H("MSIE")) && !H("Edge"),
    ...
    var ac = Lb() || H("iPod"),
        bc = H("iPad"),
        cc = H("Safari") && !((H("Chrome") || H("CriOS")) && !H("Edge") || H("Coast") || H("Opera") || H("Edge") || H("Edg/") || H("OPR") || H("Firefox") || H("FxiOS") || H("Silk") || H("Android")) && !(Lb() || H("iPad") || H("iPod"));
    var dc = {},
        ec = null;
    var fc = {
        ib: {
    ...
    function kc(a, b) {
        Ya(b, function(c, d) {
            ...
            "style" == d ? a.style.cssText = c : "class" == d ? a.className = c : "for" == d ? a.htmlFor = c : lc.hasOwnProperty(d) ? a.setAttribute(lc[d], c) : 0 == d.lastIndexOf("aria-", 0) || 0 == d.lastIndexOf("data-", 0) ? a.setAttribute(d, c) : a[d] = c
        })
    }
    var lc = {
    ...
    function mc(a, b, c) {
        var d = arguments,
            ...
            f = d[1],
            g = nc(e, String(d[0]));
        f && ("string" === typeof f ? g.className = f : Array.isArray(f) ? g.className = f.join(" ") : kc(g, f));
        2 < d.length && oc(e, g, d);
        return g
    }
    ...
    function xc() {
        ...
        function b(q) {
            ...
            for (p = 0; 80 > p; p++) {
                ...
                else 60 > p ? (P = x & A | v & (x | A), D = 2400959708) : (P = x ^ A ^ v, D = 3395469782);
                P = ((q << 5 | q >>> 27) & 4294967295) + P + K + D + t[p] & 4294967295;
                K = v;
                v = A;
        ...
        function c(q, t) {
            if ("string" === typeof q) {
                ...
                for (var p = [], x = 0, A = q.length; x < A; ++x) p.push(q.charCodeAt(x));
                q = p
            }
            t || (t = q.length);
            p = 0;
    ...
    n.clear = function() {
        for (var a = (this.h.cookie || "").split(";"), b = [], c = [], d, e, f = 0; f < a.length; f++) e = ib(a[f]), d = e.indexOf("="), -1 == d ? (b.push(""), c.push(e)) : (b.push(e.substring(0, d)), c.push(e.substring(d + 1)));
    ...
    function Gc(a) {
        ...
        e && (e = (c = 0 == c.indexOf("https:") || 0 == c.indexOf("chrome-extension:") || 0 == c.indexOf("moz-extension:")) ? z.__SAPISID : z.__APISID, e || (e = new Cc(document),
            e = e.get(c ? "SAPISID" : "APISID") || e.get("__Secure-3PAPISID")), (e = e ? yc(e, c ? "SAPISIDHASH" : "APISIDHASH", a) : null) && d.push(e), c && Ec(b) && ((b = Fc("__1PSAPISID", "__Secure-1PAPISID", "SAPISID1PHASH", a)) && d.push(b), (a = Fc("__3PSAPISID", "__Secure-3PAPISID", "SAPISID3PHASH", a)) && d.push(a)));
    ...
    function Ic(a) {
        -1 == a.h && (a.h = Ta(a.data_, function(b, c, d) {
    ...
    $c.prototype.update = function(a, b) {
        if (null != a) {
            ...
            for (var c = b - this.blockSize, d = 0, e = this.m, f = this.i; d < b;) {
                if (0 == f)
                    for (; d <= c;) ad(this, a, d), d += this.blockSize;
                if ("string" === typeof a)
                    for (; d < b;) {
    ...
    var gd = "StopIteration" in z ? z.StopIteration : {
    ...
    function id(a) {
        ...
        if ("function" == typeof a.next) return new jd(function() {
            return md(a)
        });
        if ("function" == typeof a[Symbol.iterator]) return new jd(function() {
            return a[Symbol.iterator]()
        });
        if ("function" == typeof a.C) return new jd(function() {
            return md(a.C())
        });
    ...
    n.delete = function(a) {
        return qd(this.i, a) ? (delete this.i[a], --this.size, this.j++, this.h.length > 2 * this.size && pd(this), !0) : !1
    };
    ...
    function pd(a) {
        ...
        if (a.size != a.h.length) {
            var e = {};
            for (c = b = 0; b < a.h.length;) d = a.h[b], qd(e, d) || (a.h[c++] = d, e[d] = 1), b++;
            a.h.length = c
        }
    }
    n.get = function(a, b) {
    ...
    Ad.prototype.add = function(a, b, c, d, e) {
        ...
        var g = Bd(a, b, d, e); - 1 < g ? (b = a[g], c || (b.V = !1)) : (b = new yd(b, this.src, f, !!d, e), b.V = c, a.push(b));
        return b
    };
    ...
    function Cd(a, b) {
        var c = b.type;
        c in a.listeners && Ua(a.listeners[c], b) && (zd(b), 0 == a.listeners[c].length && (delete a.listeners[c], a.h--))
    }
    ...
    function Gd(a, b, c, d, e) {
        ...
        else c = Id(c), a && a[wd] ? a.Z(b, c, C(d) ? !!d.capture : !!d, e) : Jd(a, b, c, !1, d, e)
    }
    ...
    function Hd(a, b, c, d, e) {
        ...
        else c = Id(c), a && a[wd] ? a.h.add(String(b), c, !0, C(d) ? !!d.capture : !!d, e) : Jd(a, b, c, !0, d, e)
    }

    function Od(a, b, c, d, e) {
        if (Array.isArray(b))
            for (var f = 0; f < b.length; f++) Od(a, b[f], c, d, e);
        else(d = C(d) ? !!d.capture : !!d, c = Id(c), a && a[wd]) ? a.h.remove(String(b), c, d, e) : a && (a = Kd(a)) && (b = a.listeners[b.toString()], a = -1, b && (a = Bd(b, c, d, e)), (c = -1 < a ? b[a] : null) && Pd(c))
    }
    ...
    function Pd(a) {
        if ("number" !== typeof a && a && !a.T) {
            ...
            if (b && b[wd]) Cd(b.h, a);
                ...
                var c = a.type,
                    d = a.h;
                b.removeEventListener ? b.removeEventListener(c, d, a.capture) : b.detachEvent ? b.detachEvent(Md(c), d) : b.addListener && b.removeListener && b.removeListener(d);
                Fd--;
                (c = Kd(b)) ? (Cd(c, a), 0 == c.h && (c.src = null, b[Dd] = null)) : zd(a)
            }
        }
    }
    ...
    function Rd(a, b) {
        ...
        a = a.ca;
        c = b.type || b;
        "string" === typeof b ? b = new sd(b, a) : b instanceof sd ? b.target = b.target || a : (e = b, b = new sd(c, a), db(b, e));
        e = !0;
        if (d)
        ...
        if (0 == a.h)
            if (a.j) {
                ...
                if (c.i) {
                    ...
                    e && (0 == c.h && 1 == d ? ae(c, b) : (f ? (d = f, d.next == c.l && (c.l = d), d.next = d.next.next) : be(c), ce(c, e, 3, b)))
                }
                a.j = null
            } else Vd(a, 3, b)
    }
    ...
    function Vd(a, b, c) {
        if (0 == a.h) {
            ...
            g || (a.s = c, a.h = b, a.j = null, ee(a), 3 != b || c instanceof $d || ge(a, c))
        }
    }
    ...
    n.U = function(a) {
        ...
        if (b) {
            var c = this.i[b];
            0 != this.o ? (this.l.push(a), this.h[a + 1] = Fa) : (c && Ua(c, a), delete this.h[a], delete this.h[a + 1], delete this.h[a + 2])
        }
        return !!b
    };
    n.O = function(a, b) {
    ...
    qe.prototype.i = function(a) {
        ...
        if (b) {
            var c = b.creation,
                d = b.expiration;
            if (d && d < Date.now() || c && c > Date.now()) qe.prototype.remove.call(this, a);
            else return b
        }
    };
    ...
    function ve(a, b) {
        ...
        if (c) {
            we || (we = new nd);
            this.h = we.get(a);
            this.h || (b ? this.h = document.getElementById(b) : (this.h = document.createElement("userdata"), this.h.addBehavior("#default#userData"), document.body.appendChild(this.h)), we.set(a, this.h));
            try {
                this.h.load(this.i)
            } catch (d) {
                this.h = null
    ...
    var Be, Ce, De = z.window,
        Ee = (null === (Be = null === De || void 0 === De ? void 0 : De.yt) || void 0 === Be ? void 0 : Be.config_) || (null === (Ce = null === De || void 0 === De ? void 0 : De.ytcfg) || void 0 === Ce ? void 0 : Ce.data_) || {};
    E("yt.config_", Ee);

    function Fe(a) {
        for (var b = 0; b < arguments.length; ++b);
        b = arguments;
        1 < b.length ? Ee[b[0]] = b[1] : 1 === b.length && Object.assign(Ee, b[0])
    }
    ...
    function Je(a) {
        ...
        b ? b(a, "ERROR", void 0, void 0, void 0) : (b = N("ERRORS", []), b.push([a, "ERROR", void 0, void 0, void 0]), Fe("ERRORS", b));
        He(a)
    }

    function Ke(a) {
        var b = B("yt.logging.errors.log");
        b ? b(a, "WARNING", void 0, void 0, void 0) : (b = N("ERRORS", []), b.push([a, "WARNING", void 0, void 0, void 0]), Fe("ERRORS", b))
    };
    var Le = 0;
    ...
    var Oe = z.ytEventsEventsCounter || {
        count: 0
    };
        ...
        a && ("string" == typeof a && (a = [a]), G(a, function(b) {
            if (b in $a) {
                var c = $a[b],
                    ...
                    f = c[3];
                c = c[4];
                d.removeEventListener ? Re() || "boolean" === typeof c ? d.removeEventListener(e, f, c) : d.removeEventListener(e, f, !!c.capture) : d.detachEvent && d.detachEvent("on" + e, f);
                delete $a[b]
            }
        }))
    }
    ...
    function Se(a, b, c) {
        ...
        if (a && (a.addEventListener || a.attachEvent)) {
            ...
            if (!e) {
                ...
                var g = f ? function(h) {
                    h = new Ne(h);
                    if (!pc(h.relatedTarget, function(k) {
                            return k == a
                ...
                g = Ie(g);
                a.addEventListener ? ("mouseenter" == b && f ? b = "mouseover" : "mouseleave" == b && f ? b = "mouseout" : "mousewheel" == b && "MozBoxSizing" in document.documentElement.style && (b = "MozMousePixelScroll"), Re() || "boolean" === typeof d ? a.addEventListener(b, g, d) : a.addEventListener(b, g, !!d.capture)) : a.attachEvent("on" + b, g);
                $a[e] = [a, b, c, g, d]
            }
        }
    };
    ...
    function Xe(a, b) {
        ...
        for (var c = {}, d = 0, e = b.length; d < e; d++) {
            ...
            if (1 == f.length && f[0] || 2 == f.length) try {
                var g = Ye(f[0] || ""),
                    h = Ye(f[1] || "");
                g in c ? Array.isArray(c[g]) ? Xa(c[g], h) : c[g] = [c[g], h] : c[g] = h
            } catch (q) {
                var k = q,
                    l = f[0],
                    m = String(Xe);
    ...
    function cf(a) {
        ...
        var c = a.match(Db)[1] || null,
            d = Fb(a);
        c && d ? (a = a.match(Db), b = b.match(Db), a = a[3] == b[3] && a[1] == b[1] && a[4] == b[4]) : a = d ? Fb(b) == d && (Number(b.match(Db)[4] || null) || null) == (Number(a.match(Db)[4] || null) || null) : !0;
        return a
    }
    ...
    function mf(a) {
        ...
        b = (O.vis = {
            ...
            preview: 4,
            unloaded: 5
        }[b.visibilityState || b.webkitVisibilityState || b.mozVisibilityState || ""] || 0, O.wgl = !!J.WebGLRenderingContext, O);
        c = d.call(c, e, b);
        c.ca_type = "image";
        a && (c.bid = a);
        return c
    ...
    var of = "XMLHttpRequest" in z ? function() {
    ...
    function tf(a, b) {
        ...
        if (c || !Fb(a)) b["X-YouTube-Utc-Offset"] = String(-(new Date).getTimezoneOffset());
        if (c || !Fb(a)) {
            try {
    ...
    function uf(a) {
        var b = window.location.search,
            c = Fb(a);
        Q("debug_handle_relative_url_for_query_forward_killswitch") || c || !cf(a) || (c = document.location.hostname);
    ...
    function xf(a, b) {
        ...
        b.excludeXsrf || Fb(a) && !b.withCredentials && Fb(a) != document.location.hostname || "POST" != b.method || h && "application/x-www-form-urlencoded" != h || b.postParams && b.postParams[g] || (f || (f = {}), f[c] = d);
        f && "string" === typeof e && (e = af(e), db(e, f), e = b.postBodyFormat && "JSON" == b.postBodyFormat ? JSON.stringify(e) : Ib(e));
        if (!(a = e) && (a = f)) {
            a: {
                for (var k in f) {
                    f = !1;
            ...
            a = !f
        }!sf && a && "POST" != b.method && (sf = !0, Je(Error("AJAX request with postData should use POST")));
        return e
    }
        ...
        switch (b) {
            case "JSON":
                try {
                    ...
                    throw d = Error("Error reading responseText"), d.params = a, Ke(d), g;
                }
                a = c.getResponseHeader("Content-Type") || "";
                f && 0 <= a.indexOf("json") && (")]}'\n" === f.substring(0, 5) && (f = f.substring(5)), e = JSON.parse(f));
                break;
            case "XML":
                if (a = (a = c.responseXML) ? Af(a) : null) e = {}, G(a.getElementsByTagName("*"), function(g) {
                    e[g.tagName] = Bf(g)
                })
        }
        d && Cf(e);
    ...
    function Cf(a) {
        if (C(a))
            for (var b in a) {
                ...
                if (c) {
                    c = b;
                    hb("HTML that is escaped and sanitized server-side and passed through yt.net.ajax");
                    var d = Cb(a[b], null);
                    a[c] = d
                } else Cf(a[b])
            }
    ...
    function Hf(a, b, c, d, e) {
        e = void 0 === e ? "" : e;
        if (a)
            if (c && !Ef("cobalt")) a && (a instanceof rb || (a = "object" == typeof a && a.S ? a.R() : String(a), vb.test(a) ? a = new rb(a, sb) : (a = String(a), a = a.replace(/(%0A|%0D)/g, ""), a = (b = a.match(ub)) && tb.test(b[1]) ? new rb(a, sb) : null)), a = a || wb, a instanceof rb && a.constructor === rb ? a = a.h : (Ga(a), a = "type_error:SafeUrl"), "about:invalid#zClosurez" === a || a.startsWith("data") ? a = "" : (a instanceof Bb || (b = "object" == typeof a, c = null, b && a.na && (c = a.ma()), a = Cb(jb(b && a.S ? a.R() : String(a)), c)), a instanceof Bb && a.constructor === Bb ? a = a.h : (Ga(a), a = "type_error:SafeHtml"), a = encodeURIComponent(String(Td(a.toString())))), /^[\s\xa0]*$/.test(a) || (a = mc("IFRAME", {
                src: 'javascript:"<body><img src=\\""+' + a + '+"\\"></body>"',
                style: "display:none"
            }), (9 == a.nodeType ? a : a.ownerDocument || a.document).body.appendChild(a)));
            else if (e) yf(a, b, "POST", e, d);
        else if (N("USE_NET_AJAX_FOR_PING_TRANSPORT", !1) || d) yf(a, b, "GET", "", d);
        else {
            b: {
                try {
                    var f = new Qa({
            ...
            h ? If(a) ? (b && b(), c = !0) : c = !1 : c = !1;c || Jf(a, b)
        }
    }
    ...
    var Pf = window,
        R = Pf.ytcsi && Pf.ytcsi.now ? Pf.ytcsi.now : Pf.performance && Pf.performance.timing && Pf.performance.now && Pf.performance.timing.navigationStart ? function() {
    ...
    function ag(a, b) {
        if ("log_event" === a.endpoint) {
            var c = "";
            a.X ? c = "visitorOnlyApprovedKey" : a.H && ($f[a.H.token] = bg(a.H), c = a.H.token);
            var d = Zf.get(c) || [];
            Zf.set(c, d);
            d.push(a.payload);
            b && (Uf = new b);
    ...
    function dg() {
        Q("web_gel_timeout_cap") && !Wf && (Wf = Te(function() {
            cg({
                writeThenSend: !0
            })
        }, 6E4));
    ...
    function fg(a, b, c) {
        ...
        for (var g = a.next(); !g.done; g = a.next()) {
            ...
            jg(h, e, g);
            Q("send_beacon_before_gel") && window.navigator && window.navigator.sendBeacon && !c.writeThenSend && Kf("/generate_204");
            kg(d, "log_event", h, {
                retry: !0,
                onSuccess: function() {
                    f--;
    ...
    function jg(a, b, c) {
        ...
        !c && (b = N("EVENT_ID", void 0)) && ((c = N("BATCH_CLIENT_COUNTER", void 0) || 0) || (c = Math.floor(Math.random() * Rf / 2)), c++, c > Rf && (c = 1), Fe("BATCH_CLIENT_COUNTER", c), b = {
            serializedEventId: b,
            clientCounter: String(c)
        }, a.serializedClientEventId = b, Sf && Tf && Q("log_gel_rtt_web") && (a.previousBatchInfo = {
    ...
    function gg(a) {
        ...
        N("DELEGATED_SESSION_ID") && !Q("pageid_as_header_web") && (b.user = {
    ...
    function rg(a, b, c) {
        ...
        (b = c.fb || N("AUTHORIZATION")) || (a ? b = "Bearer " + B("gapi.auth.getToken")().eb : b = Gc([]));
        b && (d.Authorization = b, d["X-Goog-AuthUser"] = N("SESSION_INDEX", 0), Q("pageid_as_header_web") && (d["X-Goog-PageId"] = N("DELEGATED_SESSION_ID")));
        return d
    };
    ...
    function tg(a) {
        var b = new ue;
        (b = b.isAvailable() ? a ? new Ae(b, a) : b : null) || (a = new ve(a || "UserDataSharedStore"), b = a.isAvailable() ? a : null);
    ...
    tg.prototype.get = function(a, b) {
        ...
        if (d && (c = Dc.get("" + a, void 0)) && (c = unescape(c), b)) try {
            c = JSON.parse(c)
        } catch (e) {
        ...
        if (b) {
            for (var c in b) {
                ...
                if (!(6E4 > Math.round(R()) - d.requestTime)) {
                    var e = d.authState,
                        f = sg(rg(!1));
                    ab(e, f) && (e = d.request, "requestTimeMs" in e && (e.requestTimeMs = Math.round(R())), kg(a, d.method, e, {}));
                    delete b[c]
                }
            }
            vg().set("requests", b, 86400, !0)
    ...
    var S = {},
        Lg = (S.AUTH_INVALID = "No user identifier specified.", S.EXPLICIT_ABORT = "Transaction was explicitly aborted.", S.IDB_NOT_SUPPORTED = "IndexedDB is not supported.", S.MISSING_INDEX = "Index not created.", S.MISSING_OBJECT_STORE = "Object store not created.", S.DB_DELETED_BY_MISSING_OBJECT_STORE = "Database is deleted because an expected object store was not created.", S.UNKNOWN_ABORT = "Transaction was aborted for unknown reasons.", S.QUOTA_EXCEEDED = "The current transaction exceeded its quota limitations.", S.QUOTA_MAYBE_EXCEEDED =
            "The current transaction may have failed because of exceeding quota limitations.", S.EXECUTE_TRANSACTION_ON_CLOSED_DB = "Can't start a transaction on a closed database", S.INCOMPATIBLE_DB_VERSION = "The binary is incompatible with the database version", S),
        T = {},
        Mg = (T.AUTH_INVALID = "ERROR", T.EXECUTE_TRANSACTION_ON_CLOSED_DB = "WARNING", T.EXPLICIT_ABORT = "IGNORED", T.IDB_NOT_SUPPORTED = "ERROR", T.MISSING_INDEX = "WARNING", T.MISSING_OBJECT_STORE = "ERROR", T.DB_DELETED_BY_MISSING_OBJECT_STORE = "WARNING", T.QUOTA_EXCEEDED =
            "WARNING", T.QUOTA_MAYBE_EXCEEDED = "WARNING", T.UNKNOWN_ABORT = "WARNING", T.INCOMPATIBLE_DB_VERSION = "WARNING", T),
        U = {},
        Ng = (U.AUTH_INVALID = !1, U.EXECUTE_TRANSACTION_ON_CLOSED_DB = !1, U.EXPLICIT_ABORT = !1, U.IDB_NOT_SUPPORTED = !1, U.MISSING_INDEX = !1, U.MISSING_OBJECT_STORE = !1, U.DB_DELETED_BY_MISSING_OBJECT_STORE = !1, U.QUOTA_EXCEEDED = !1, U.QUOTA_MAYBE_EXCEEDED = !0, U.UNKNOWN_ABORT = !0, U.INCOMPATIBLE_DB_VERSION = !1, U);
    ...
    oa(Pg, Error);
    var Qg = ["The database connection is closing", "Can't start a transaction on a closed database", "A mutation operation was attempted on a database that did not allow mutations"];

    function Rg(a, b, c, d) {
        b = Kg(b);
        var e = a instanceof Error ? a : Error("Unexpected error: " + a);
        if (e instanceof V) return e;
        if ("QuotaExceededError" === e.name) return new V("QUOTA_EXCEEDED", {
            objectStoreNames: c,
            dbName: b
        });
        if (cc && "UnknownError" === e.name) return new V("QUOTA_MAYBE_EXCEEDED", {
            objectStoreNames: c,
            dbName: b
        });
        if (e instanceof Pg) return new V("MISSING_INDEX", {
            dbName: b,
            dbVersion: d,
            objectStore: e.objectStore,
            index: e.index
        });
        if ("InvalidStateError" === e.name && Qg.some(function(f) {
                return e.message.includes(f)
            })) return new V("EXECUTE_TRANSACTION_ON_CLOSED_DB", {
            objectStoreNames: c,
            dbName: b
        });
        if ("AbortError" === e.name) return new V("UNKNOWN_ABORT", {
            objectStoreNames: c,
            dbName: b
        }, e.message);
        e.args = [{
    ...
    W.all = function(a) {
        return new W(new Vg(function(b, c) {
            var d = [],
                e = a.length;
            0 === e && b(d);
            for (var f = {
                    ...
                    M: f.M
                }, ++f.M) Wg(W.resolve(a[f.M]).then(function(g) {
                return function(h) {
                    d[g.M] = h;
                    e--;
                    0 === e && b(d)
    ...
    W.prototype.then = function(a, b) {
        ...
        return new W(new Vg(function(f, g) {
            "PENDING" === c.state.status ? (c.h.push(function() {
                Xg(c, c, d, f, g)
            }), c.onRejected.push(function() {
                Yg(c, c, e, f, g)
            })) : "FULFILLED" === c.state.status ? Xg(c, c, d, f, g) : "REJECTED" === c.state.status && Yg(c, c, e, f, g)
        }))
    };
    ...
    function bh(a, b) {
        return new W(new Vg(function(c, d) {
            function e() {
                var f = a ? b(a) : null;
                f ? f.then(function(g) {
                    a = g;
            ...
            return y(f, function(D) {
                switch (D.h) {
                    ...
                    case 2:
                        ...
                        return w(D, O, 6);
                    case 6:
                        return p = D.i, x = Math.round(R()), hh(g, q, x, l, void 0, b.join(), h), D.return(p);
                    case 4:
                        A = ta(D);
                        v = Math.round(R());
                        K = Rg(A, g.h.name, b.join(), g.h.version);
                        if ((P = K instanceof V && !K.h) || l >= k) hh(g, q, v, l, K, b.join(), h), m = K;
                        D.v(2);
                        break;
                    case 3:
    ...
    function hh(a, b, c, d, e, f, g) {
        b = c - b;
        e ? (e instanceof V && ("QUOTA_EXCEEDED" === e.type || "QUOTA_MAYBE_EXCEEDED" === e.type) && Gg("QUOTA_EXCEEDED", {
            dbName: Kg(a.h.name),
            objectStoreNames: f,
            transactionCount: a.transactionCount,
            transactionMode: g.mode
        }), e instanceof V && "UNKNOWN_ABORT" === e.type && (c -= a.j, 0 > c && c >= Math.pow(2, 31) && (c = 0), Gg("TRANSACTION_UNEXPECTEDLY_ABORTED", {
            objectStoreNames: f,
            transactionDuration: b,
            transactionCount: a.transactionCount,
            dbDuration: c
        }), a.i = !0), ih(a, !1, d, f, b, g.tag), Fg(e)) : ih(a, !0, d, f, b, g.tag)
    }
    ...
    n.index = function(a) {
        try {
            ...
            if (b instanceof Error && "NotFoundError" === b.name) throw new Pg(a, this.h.name);
            throw b;
        }
    };
    n.getName = function() {
                ...
                return y(g, function(p) {
                    switch (p.h) {
                        ...
                        case 4:
                            ...
                            a: {
                                var x = h.options;
                                for (var A = u(Object.keys(x.ga)), v = A.next(); !v.done; v = A.next()) {
                                    v = v.value;
                                    var K = x.ga[v],
                                        P = void 0 === K.Pa ? Number.MAX_VALUE : K.Pa;
                                    if (k.h.version >= K.ia && !(k.h.version >= P) && !k.h.objectStoreNames.contains(v)) {
                                        x = v;
                                        break a
                                    }
                                }
                            ...
                            return w(p,
                                h.delete(), 7);
                        case 7:
                            return Fg(new V("DB_DELETED_BY_MISSING_OBJECT_STORE", {
                                dbName: h.name,
                                Na: l
                            })), p.return(a());
                        case 6:
                        ...
                        case 9:
                            q = p.i;
                            t = q.h.version;
                            if (void 0 !== h.options.version && t > h.options.version + 1) throw q.close(), h.l = !1, uh(h, t);
                            return p.return(q);
                        case 8:
                            throw b(), m;
                    }
    ...
    var vh = new th("YtIdbMeta", {
        ...
        upgrade: function(a, b) {
            b(1) && a.h.createObjectStore("databases", {
                keyPath: "actualName"
            })
        }
    });
    ...
    function wh(a) {
        return I(this, function c() {
            ...
            return y(c, function(e) {
                ...
                d = e.i;
                return e.return(dh(d, ["databases"], {
                    D: !0,
                    mode: "readwrite"
                }, function(f) {
                    var g = f.objectStore("databases");
                    return g.get(a.actualName).then(function(h) {
                        if (h ? a.actualName !== h.actualName || a.publicName !== h.publicName || a.userIdentifier !== h.userIdentifier : 1) return X(g.h.put(a, void 0)).then(function() {})
                    })
                }))
            })
        })
            ...
            return y(b, function(f) {
                switch (f.h) {
                    case 1:
                        ...
                        var g;
                        if (g = Df) g = /WebKit\/([0-9]+)/.exec(xb), g = !!(g && 600 <= parseInt(g[1], 10));
                        g && (g = /WebKit\/([0-9]+)/.exec(xb), g = !(g && 602 <= parseInt(g[1], 10)));
    ...
    function Ph() {
        return I(this, function b() {
            ...
            return y(b, function(l) {
                ...
                if (3 != l.h) return d = l.i, e = N("INNERTUBE_CONTEXT_CLIENT_NAME", 0), f = ["NEW", e, 0], g = ["NEW", e, R()], h = IDBKeyRange.bound(f, g), k = void 0, w(l, dh(d, ["LogsRequestsStore"], {
                    mode: "readwrite",
                    D: !0
                }, function(m) {
                    return oh(m.objectStore("LogsRequestsStore").index("newRequestV2"), {
                        query: h,
                        direction: "prev"
                    }, function(q) {
                        q.cursor.value && (k =
                            q.cursor.value, k.status = "QUEUED", q.update(k))
                    })
                }), 3);
                c.Ra = R();
                Oh(c);
    ...
    function Qh(a) {
        return I(this, function c() {
            ...
            return y(c, function(e) {
                ...
                d = e.i;
                return e.return(dh(d, ["LogsRequestsStore"], {
                    mode: "readwrite",
                    D: !0
                }, function(f) {
                    var g = f.objectStore("LogsRequestsStore");
                    return g.get(a).then(function(h) {
                        if (h) return h.status = "QUEUED", X(g.h.put(h, void 0)).then(function() {
                            return h
                        })
                    })
                }))
        ...
        return I(this, function c() {
            ...
            return y(c, function(e) {
                ...
                return e.return(dh(d, ["LogsRequestsStore"], {
                    ...
                    var g = f.objectStore("LogsRequestsStore");
                    return g.get(a).then(function(h) {
                        return h ? (h.status = "NEW", h.sendCount += 1, X(g.h.put(h, void 0)).then(function() {
                            return h
                        })) : W.resolve(void 0)
                    })
                }))
    ...
    function $h(a) {
        a.B = gf(function() {
            return I(a, function c() {
                var d = this;
                return y(c, function(e) {
                    if (1 == e.h) return d.i ? d.da() || !d.l ? e.v(3) : w(e, d.L(), 3) : w(e, d.L(), 3);
                    $h(d);
                    e.h = 0
                })
            })
        ...
        return this.o ? this.o : this.o = new Promise(function(c) {
            return I(b, function e() {
                ...
                return y(e, function(l) {
                    switch (l.h) {
                        case 1:
                            return f = window.AbortController ? new window.AbortController : void 0, g = null === f || void 0 === f ? void 0 : f.signal, h = !1, sa(l, 2, 3), f && (k.u = jf(function() {
                                f.abort()
                        ...
                        case 3:
                            ...
                            k.o = void 0;
                            k.u && lf(k.u);
                            h !== k.i && (k.i = h, k.i && k.l ? Rd(k, "ytnetworkstatus-online") : k.l && Rd(k, "ytnetworkstatus-offline"));
                            c(h);
                            va(l);
                            break;
                        case 2:
    ...
    function ai(a) {
        ...
        c && c(a.Ea);
        a.Ma && (c = B("yt.networkStatusManager.instance.enableErrorFlushing").bind(this.i)) && c();
        if (c = B("yt.networkStatusManager.instance.listen").bind(this.i)) a.ba ? (this.ba = a.ba, c("ytnetworkstatus-online", function() {
    ...
    function bi(a, b) {
        a.ba ? a.l ? (lf(a.u), a.u = jf(function() {
            a.o !== b && (Rd(a, b), a.o = b, a.l = R())
        }, a.ba - (R() - a.l))) : (Rd(a, b), a.o = b, a.l = R()) : Rd(a, b)
    };
    var ci = 0,
        di = 0,
        ei, fi = z.ytNetworklessLoggingInitializationOptions || {
            isNwlInitialized: !1,
    ...
    function gi(a, b) {
        ...
        b = void 0 === b ? {} : b;
        Q("skip_is_supported_killswitch") ? Ch().then(function(d) {
            c(d)
        }) : c(li())
    }
        ...
        ci || (ci = jf(function() {
            return I(a, function c() {
                ...
                return y(c, function(e) {
                    ...
                    if (3 != e.h) return d = e.i, d ? w(e, ki(d), 3) : (lf(ci), ci = 0, e.return());
                    ci && (ci = 0, ni());
                    e.h = 0
                })
            })
        ...
        return I(this, function c() {
            ...
            return y(c, function(g) {
                switch (g.h) {
                    ...
                    case 3:
                        (f = g.i) ? a = f: Ke(Error("The request cannot be found in the database."));
                    case 2:
                        var h = a.timestamp;
                        if (!(2592E6 <= R() - h)) {
                            g.v(4);
                        ...
                        Ke(Error("Networkless Logging: Stored logs request expired age limit"));
                        if (void 0 === a.id) {
                            g.v(5);
                            break
                        }
                    ...
                    case 4:
                        ...
                        h = a;
                        var k, l;
                        if (null === (l = null === (k = null === h || void 0 === h ? void 0 : h.options) || void 0 === k ? void 0 : k.postParams) || void 0 === l ? 0 : l.requestTimeMs) h.options.postParams.requestTimeMs = Math.round(R());
                        a = h;
                        if (!a) {
                            g.v(0);
                            break
    ...
    function oi(a) {
        ...
        a.options.onError = function(e, f) {
            return I(b, function h() {
                return y(h, function(k) {
                    switch (k.h) {
                        case 1:
                            if (!((B("ytNetworklessLoggingInitializationOptions") ? fi.potentialEsfErrorCounter : di) <= ef("potential_esf_error_limit", 10))) {
                                k.v(2);
                                break
                            }
                            return w(k, hi().L(), 3);
                        case 3:
                            if (hi().J()) B("ytNetworklessLoggingInitializationOptions") && fi.potentialEsfErrorCounter++, di++;
                        ...
                        case 2:
                            ...
                            return 1 > a.sendCount ? w(k, Rh(a.id), 8) : w(k, Sh(a.id),
                                4);
                        case 8:
                            jf(function() {
                                hi().J() && ni()
        ...
        a.options.onSuccess = function(e, f) {
            return I(b, function h() {
                return y(h, function(k) {
                    if (1 == k.h) return void 0 === (null === a || void 0 === a ? void 0 : a.id) ? k.v(2) : w(k, Sh(a.id), 2);
                    d(e, f);
                    k.h = 0
                })
            })
    ...
    function ii() {
        return B("ytNetworklessLoggingInitializationOptions") ? fi.isNwlInitialized : !1
    }

    function li() {
        return B("ytNetworklessLoggingInitializationOptions") ? fi.databaseToken : void 0
    };
    ...
    function kg(a, b, c, d) {
        function e(t) {
            t = void 0 === t ? !1 : t;
            var p;
            if (d.retry && "www.youtube-nocookie.com" != h && (t || (p = wg(b, c, l, k)), p)) {
                var x = g.onSuccess,
                    A = g.onFetchSuccess;
            ...
            try {
                t && d.retry && !d.qa.bypassNetworkless ? (g.method = "POST", d.qa.writeThenSend ? gi(q, g) : mi(q, g)) : (g.method = "POST", g.postParams || (g.postParams = {}), vf(q, g))
            } catch (v) {
                if ("InvalidAccessError" == v.name) p && (xg(p), p = 0), Ke(Error("An extension is blocking network request."));
                else throw v;
            }
            p && gf(function() {
                yg(a)
            }, 5E3)
        }!N("VISITOR_DATA") && "visitor_id" !== b && .01 > Math.random() && Ke(new Hg("Missing VISITOR_DATA when sending innertube request.", b, c, d));
        if (!a.isReady()) {
        ...
        a.config_.Ka && g.headers.Authorization || (m.key = a.config_.innertubeApiKey);
        var q = bf("" + h + f, m || {}, !0);
        ii() ? Bh().then(function(t) {
            e(t)
        }) : e(!1)
    };
    ...
    function qi(a, b) {
        ...
        Q("log_sequence_info_on_gel_web") && c.sa && (a = e.context, b = c.sa, lg[b] = b in lg ? lg[b] + 1 : 0, a.sequence = {
            index: lg[b],
            groupKey: b
        }, c.hb && delete lg[c.sa]);
        (c.mb ? eg : ag)({
    ...
    function Ai(a, b, c, d) {
        if (a)
            if (Array.isArray(a)) {
                var e = d;
                for (d = 0; d < a.length && !(a[d] && (e += Bi(d, a[d], b, c), 500 < e)); d++);
                d = e
            ...
            for (e in a) {
                if (a[e]) {
                    ...
                    var g = b;
                    var h = c;
                    g = "string" !== typeof f || "clickTrackingParams" !== e && "trackingParams" !== e ? 0 : (f = yi(atob(f.replace(/-/g, "+").replace(/_/g, "/")))) ? Bi(e + ".ve", f, g, h) : 0;
                    d += g;
                    d += Bi(e, a[e], b, c);
                    if (500 < d) break
                }
    ...
    function Ki(a) {
        return Ji[a] || (Ji[a] = String(a).replace(/\-([a-z])/g, function(b, c) {
    ...
    function Pi(a, b) {
        var c;
        "yt:" === a.tagName.toLowerCase().substr(0, 3) ? c = a.getAttribute(b) : c = a ? a.dataset ? a.dataset[Ki(b)] : a.getAttribute("data-" + b) : null;
        return c
    }
    ...
    function Si(a, b, c) {
        Ti || (Ti = {}, Se(window, "message", function(d) {
            a: {
                if (d.origin === Z(a, "host")) {
                    ...
                    if (d = Ti[e.id]) d.s = !0, d.s && (G(d.o, d.sendMessage, d), d.o.length = 0), d.ha(e)
                }
                e = void 0
            }
            return e
    ...
    n.setup = function(a, b) {
        ...
        if (a = "string" === typeof a ? c.getElementById(a) : a)
            if (c = "iframe" === a.tagName.toLowerCase(), b.host || (b.host = c ? Gb(a.src) : "https://www.youtube.com"), this.i = new Ri(b), c || (b = Zi(this, a), this.m = a, (c = a.parentNode) && c.replaceChild(b, a), a = b), this.h = a, this.h.id || (this.h.id = "widget" + Ia(this.h)), Li[this.h.id] = this, window.postMessage) {
                this.l = new M;
                $i(this);
                b = Z(this.i, "events");
                for (var d in b) b.hasOwnProperty(d) && this.addEventListener(d, b[d]);
                for (var e in Ni) Ni.hasOwnProperty(e) &&
                    Xi(this, e)
            }
    };
                        ...
                        if (e) {
                            ...
                            if (!(5 <= Ei)) {
                                ...
                                if (e.hasOwnProperty("args") && e.args && e.args.length)
                                    for (g = 0; g < e.args.length && !(t = Ai(e.args[g], "params." + g, k, t), 500 <= t); g++);
                                ...
                                if (Hi.length)
                                    for (g = 0; g < Hi.length && !(t = Ai(Hi[g], "params.context." +
                                            g, k, t), 500 <= t); g++);
                                ...
                                if ("IGNORED" === e.level) e = 0;
                                    ...
                                    for (h = f.next(); !h.done; h = f.next())
                                        if (h = h.value, g.message && g.message.match(h.jb)) {
                                            e = h.weight;
                                            break a
                                        }
                                    e = u(e.I);
                                ...
                                for (f = g.next(); !f.done; f = g.next())
                                    if (f = f.value, f.aa[e.name])
                                        for (q = u(f.aa[e.name]), h = q.next(); !h.done; h = q.next())
                                ...
                                e.params || (e.params = {});
                                g = wi();
                                e.params["params.errorServiceSignature"] = "msg=" + g.K.length + "&cb=" + g.I.length;
                                e.params["params.serviceWorker"] = "false";
                                z.document && z.document.querySelectorAll &&
                                    (e.params["params.fscripts"] = String(document.querySelectorAll("script:not([nonce])").length));
                                hb("sample").constructor !== fb && (e.params["params.fconst"] = "true");
                                window.yterr && "function" === typeof window.yterr && window.yterr(e);
                                if (0 !== e.sampleWeight && !Di.has(e.message)) {
                                    "ERROR" === d ? (xi.O("handleError", e), Q("record_app_crashed_web") && 0 === Gi && 1 === e.sampleWeight && (Gi++, qi("appCrashed", {
                                        appCrashType: "APP_CRASH_TYPE_BREAKPAD"
                                    })), Fi++) : "WARNING" === d && xi.O("handleWarning", e);
                                    if (Q("kevlar_gel_error_routing")) {
                                        ...
                                        if (f) f = void 0;
                                            ...
                                            N("FEXP_EXPERIMENTS") && (q.experimentIds = N("FEXP_EXPERIMENTS"));
                                            if (l = l.params)
                                        ...
                                        f && (qi("clientError", f), ("ERROR" === g || Q("errors_flush_gel_always_killswitch")) && cg())
                                    }
                                    if (!Q("suppress_error_204_logging")) {
                                        ...
                                        if (d.postParams) {
                                            ...
                                            if (g = N("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS", void 0))
    ...
    n.ha = function(a) {
        ...
        switch (b) {
            case "apiInfoDelivery":
                if (C(a))
                    for (var c in a) a.hasOwnProperty(c) && (this.F[c] = a[c]);
                break;
            case "infoDelivery":
                dj(this, a);
                break;
            case "initialDelivery":
                C(a) && (window.clearInterval(this.j), this.playerInfo = {}, this.F = {}, ej(this, a.apiInterface), dj(this, a));
                break;
            default:
                Vi(this, b, a)
        }
    ...
    n.getOptions = function(a) {
        return this.F.namespaces ? a ? this.F[a] ? this.F[a].options || [] : [] : this.F.namespaces || [] : []
    };
        ...
        if (c.querySelectorAll && c.querySelector) b = c.querySelectorAll(".yt-player");
            ...
            if (b.querySelectorAll && b.querySelector) b = b.querySelectorAll(".yt-player");
                ...
                for (c = d = 0; b = e[c]; c++) {
                    var g = b.className,
                        h;
                    if (h = "function" == typeof g.split) h = 0 <= Sa(g.split(/\s+/),
                        "yt-player");
                    h && (f[d++] = b)
                }
                f.length = d;
    ...
    "undefined" != typeof YTConfig && YTConfig.parsetags && "onload" != YTConfig.parsetags || Oi();
    var gj = z.onYTReady;
    gj && gj();
